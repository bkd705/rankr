...
Route::group(['middleware' => ['jwt.auth']], function () {
    ...
    Route::get('leaderboard/{leaderboardId}/member', 'LeaderboardController@members');
    Route::put('leaderboard/{leaderboardId}/member', 'LeaderboardController@updateMembers');
